...
reset_all_storage_variables <- function() {
  ...
  rv.REACTIONLAWS$laws = data.frame(
    Name = c("Mass Action", "Mass Action (Regulated)", "Synthesis", "Degradation (Rate)", "Degradation (Enzyme)", "Michaelis Menten", "Exponential Growth", "Logistic Competition", "Monod Growth"),
    BackendName = c("mass_action", "mass_action_w_reg", "synthesis", "degradation_rate", "degradation_by_enzyme", "michaelis_menten", "exponential_growth", "logistic_competition", "monod_growth"),
    Type = c("chemical", "chemical", "chemical", "chemical", "chemical", "enzyme", "bacterial", "bacterial", "bacterial")
  )
